const aIndexAlert4UnP01 = "<div style='color:Red; font-size: 15px;'><b><center>PLEASE TRY AGAIN!!<br> กรุณาลองอีกครั้ง</center></b></div><p>Invalid username/password<br>username/password ไม่ถูกต้อง</p>";
const aIndexAlert4UnP02 = "Please check OTP from your e-Mail again !!<br>กรุณาตรวจสอบ OTP จากอีเมลของคุณอีกครั้ง!!";
const aIndexAlert4UnP03 = "<div style='color:darkgreen; font-size: 11px; font-family: Tahoma, sans-serif;'><p>Already sent OTP to email<br> OTP ถูกส่งไปยังอีเมลของคุณแล้ว</p></div>";
const aIndexAlert4UnP11 = "<p><div style='color:green; font-size: 11px;'>Forgot your password, Please click 'Forgot password' </p>ลืมรหัสผ่านของคุณ กรุณาคลิก 'Forgot password'</p></div>";
const aFeetCardAlert01 = "<div style='color:darkblue; font-size: 16px;'>Please Input the needed field before Confirm <br><br><b>Check these Columns </b><br> Bill Amount, Expenses Type";
const aIncomeAlert01 = "<div style='color:darkblue; font-size: 16px;'>Please Input the needed field before Confirm <br><b>Please Check</b><br>Average Value under limit do not need to declare.<br>Type Of Receive/Gift<br>Detail of Gift<br>Purpose ";
const aTravelEnAlert01 = "<div style='color:darkblue; font-size: 16px;'>Please Input the needed field before pressing Confirm <br><br><br><b>Check these Columns </b><br> Description, Purpose,Company/Personal Name <br> Type of Reimbursement,Original currency,Reimbursement <br><br> <b>Currency and Exchange rates</b> <br> Currency,X-Rate</div>";
...
const aEmailTRF = [
    ...
    "</div>",
    "<br>ผู้ขออนุมัติได้เรียกข้อมูล ",
    " Travel Requisition Form สำหรับ REFNO = [",
    "]<br> กลับไปแก้ไข <br> ใช้งานโปรแกรมที่ ",
    "<br><br><br><b>",
    "</b></div>",
    "<br>HR ได้ดำเนินการ Confirm รายการ ",
    "<br><br>เรียนมาเพื่อโปรดทราบ<br><br>ขอแสดงความนับถือ<br>",
    ",<br>  ได้ดำเนินการเสร็จเรียบร้อยแล้ว ",
]; //0 11 2 3 12