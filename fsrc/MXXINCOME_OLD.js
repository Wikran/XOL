                                                            ...
                                                            onClick: function (e) {
                                                                ...
                                                                result.done(function (dresult) {
                                                                    if (dresult) {
                                                                        ...
                                                                        //use ExtraOnLine; UPDATE GIFTREC  SET Confirmed = 1 Where HeadRefNo = 'M2108063704'
                                                                    ...
                                                                    if (aRecNo === 1) {
                                                                        ...
                                                                        result.done(function (dresult) {
                                                                            if (dresult) {
                                                                                ...
                                                                                // delete data
                                                                                // DELETE FROM GIFTREC WHERE HeadRefNo = 'M2110120750'
                                                                ...
                                                                if (atestCehcka === 1) { DevExpress.ui.dialog.alert(aArrays.aIncomeAlert[0], aArrays.aIncomeAlert[1]); }
                                                                    ...
                                                                    result.done(function (dresult) {
                                                                        if (dresult) {
                                                                            ...
                                                                            //use ExtraOnLine; UPDATE GIFTREC  SET Confirmed = 1 Where HeadRefNo = 'M2108063704' ERORefNo6
                                                                            ...
                                                                            //let aMessage01 = "<div>เรียน คุณ" + $.trim(aApproverName) + ",<br>&nbsp;&nbsp;&nbsp;&nbsp;��سҵ�Ǩ�ͺ ���͹��ѵ���¡�� " + aaOnInitExpGroupDesc + " Expenses ����Ѻ REFNO = [" + aRefNoa + "]<br> ����ö�������������� " + aAddress2Do + " (��Ǣ�� Approve --> HOD Approve) <br><br>���ʴ������Ѻ���<br>" + aRequesterName + "</div>"
