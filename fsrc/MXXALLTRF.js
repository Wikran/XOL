...
const aaPurposeTable = [
    { "Purpose": "Conference", "TPurpose": "สัมมนา" },
    { "Purpose": "Training", "TPurpose": "อบรม" },
    { "Purpose": "Traveling", "TPurpose": "เดินทาง" },
    //{ "Purpose": "Others", "TPurpose": "๏ฟฝ๏ฟฝ๏ฟฝ๏ฟฝ" }
]
const aaYesNoList = [
    { "Code": "YES" },
    { "Code": "NO" },
                    ...
                    $(() => {
                        ...
                        fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(axFullBody) }), redirect: "follow" })
                            ...
                            .then(acData => {
                                ...
                                //console.log(aaSubGroup01); // ACCOUNT code
                                    ...
                                    .then(hData => {
                                        ...
                                        if (jQuery.type(aaaHODApprover[0]) === "undefined") {
                                            DevExpress.ui.dialog.alert({
                                                ...
                                                title: "ERROR SETTING!!",
                                                messageHtml: "<div>Un-completed system setup, please contact Administrator<br> กรุณาติดต่อผู้ดูแลระบบ</div>"
                                            });
                                            System.exit(0);
                                        }
                                        ...
                                        $("#gridContainer").dxDataGrid({
                                                    ...
                                                    buttons: [
                                                        {
                                                            ...
                                                            visible: (aMMaMx === "faSupervisor" || aMMaMx === "admin"), //false,
                                                            //visible: function (e) {
                                                            ...
                                                            onClick: function (e) {
                                                                ...
                                                                result.done(function (dresult) {
                                                                    if (dresult) {
                                                                        ...
                                                                        //let aMessage01 = "<div>เรียน คุณ" + $.trim(aApproverName) + "<br>ผู้ขออนุมัติได้เรียกข้อมูล " + aaOnInitExpGroupDesc + " Expenses Reimbursement สำหรับ REFNO = [" + e.row.data.HeadRefNo + "]<br> กลับไปแก้ไข <br> ใช้งานโปรแกรมที่ " + aAddress2Do + "<br><br><br><b>" + aRequesterName + "</b></div>"
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            onClick: function (e) {
                                                                ...
                                                                //send Email
                                                                let aaMailTitle = aaOnInitExpGroupDesc.toUpperCase() + " Travel Requisition Form<br> Request For Approve";
                                                                ...
                                                                let aAddress2Do = "<a href='" + aaPFDMI + "/XOL/index.html'>Expenses Reimburse</a>"; //<a href='https://www.w3schools.com'>Visit W3Schools</a>
                                                                let aMessage01 = "<div>���? " + $.trim(aApproverName) + ",<br>��??�?�?���?��??������� " + aaOnInitExpGroupDesc + " ����? REFNO = [" + e.row.data.HeadRefNo + "]<br> ��� (" + aAddress2Do + "). <br><br>���?������?���,<br>" + aRequesterName + "</div>";
                                                                ...
                                                                aMessageAlert("Already Requested to HOD", "DarkGreen")
                                                            }
                                                        },
                                                        {
                                                            hint: "Print",
                                                            ...
                                                            onClick: function (e) {
                                                                ...
                                                                aRPTPrint2Pdf(e.row.data.HeadRefNo, aaPFDMI, "TMasterReport", "Travel Requisition Form") //T2302163889 e.row.data.HeadRefNo
                                                                e.component.refresh(true);
                                                                e.component.refresh(true);
                                                                e.component.refresh(true);
                                                                e.component.refresh(true);
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            visible: false,
                                                            onClick: function (e) {
                                                                let aKeyData = e.row.data.HeadRefNo

                                                                let afilteredData = $.grep(aaAllData, function (item) {
                                                                    return item.HeadRefNo === aKeyData;
                                                                });
                                                                ...
                                                                let aextData = afilteredData.map(function (item) {
                                                                    var value1 = "ID"
                                                                    return {
                                                                        ID: item.ID,
                                                                        ERORefNo4: item.ERORefNo4,
                                                                        ERODate01: item.ERODate01,
                                                                        ERODesc02: item.ERODesc02,
                                                                        ERODesc03: item.ERODesc03,
                                                                        ERODesc04: item.ERODesc04,
                                                                        ERORefNo3: item.ERORefNo3,
                                                                        ExpensesCode: item.ExpensesCode,
                                                                ...
                                                                let aTableFromDataX = generateTableXX(aextData, aMulSet01);

                                                                let aaSchRefx = "HeadRefNo LIKE '%" + aKeyData + "%'"
                                                                fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "891F052B-E489-41E3-A254-A038B66C0444", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(aaSchRefx) }), redirect: "follow" })
                                                                    .then(response => response.json())
                                                                    //
                                                                    .then(aData => {
                                                                        var aeData = aData;
                                                                        ...
                                                                        let aeacData = aeData.map(function (item) { //"DC, ExpensesCode,EAccDesc,Division, DRAMT, CRAMT"
                                                                            return {
                                                                                DC: item.DC,
                                                                                ExpensesCode: item.ExpensesCode,
                                                                                EAccDesc: item.EAccDesc,
                                                                                Division: item.Division,
                                                                                DRAMT: item.DRAMT,
                                                                                CRAMT: item.CRAMT,
                                                                            };
                                                                        });
                                                                        let aTableFromDataY = generateTableXX(aeacData, aMulSet02);
                                                                        console.log(aTableFromDataY)

                                                                        //aPopUpPrintForm(e.row.data, e.row.data.HeadRefNo, aTableFromDataX, aTableFromDataY); // arTAccount[0] aextData
                                                                        aPrint2PDF4HTML(e.row.data, e.row.data.HeadRefNo, aTableFromDataX, aTableFromDataY);
                                                                        e.component.refresh(true);
                                                                        e.component.refresh(true);
                                                                        e.component.refresh(true);
                                                                        e.component.refresh(true);
                                            ...
                                            onToolbarPreparing: function (e) {
                                                ...
                                                e.toolbarOptions.items.unshift(
                                                    ...
                                                    //                     .text("ALL " + aaOnInitExpGroupDesc.toUpperCase()), //" FOR "
                                                    //                 $("<br><center />"),
                                        ...
                                        const aPopUpAddForm = (aRecNo, iData, idDate, iView) => {
                                            ...
                                            if (aRecNo === 1) {
                                                ...
                                                */
                                                ...
                                                var ObjKeyData = { EntryBy: aaUsrN, EntryDate: new Date(), ERODate01: idDate, ID: aaID, HeadRefNo: axRunRun, REFNO: axLineNo, PayToCode: asStaffID, PayToName: asFullName, Department: asDepartment, Division: asDivision, ERODesc06: asStaffEmail, ReqDate: aNowDte, ExpensesCode: "", ExpensesDescription: aaOnInitAccDesc, Currency: "THB", Xrate: 1, ExpGroupCode: aaOnInitExpGroupCode, ExpGroupDescEng: aaOnInitExpGroupDesc, ERStatus: asERStatus, ERORefNo1: "", ERORefNo2: "", ERORefNo3: "", EROCheck01: 0, EROCheck02: 0, NeedPayment: 0, RefundedAmount: asRefundedAmount, LimitedAmount: 0, ERODesc02: asERODesc02, ERODesc03: asERODesc03, ERODesc04: asERODesc04, ERODesc05: asERODesc05, ERODate02: new Date(), ERODate03: new Date(), ERODate05: new Date(), ERODate06: new Date(), Vendor01: asVendor01, Note: asNote, EROAmount1: asEROAmount1 }
                                            ...
                                            $(() => {
                                                ...
                                                $("#Add-popupexit").dxButton({
                                                    icon: ((aMMaMx === "faSupervisor" || aMMaMx === "admin") && aViewG ? "fas fa-check-circle" : "fas fa-times"),
                                                    type: ((aMMaMx === "faSupervisor" || aMMaMx === "admin") && aViewG ? "default" : "danger"), //"danger",
                                                    text: ((aMMaMx === "faSupervisor" || aMMaMx === "admin") && aViewG ? "EXIT & SAVE" : "EXIT"),
                                                    visible: true,
                                                    onClick: function (e) {
                                                        $("#gridContainer").dxDataGrid("instance").refresh();
                                                                ...
                                                                aaLoadData(isLocalHost(), aDatabasea, aKeyIDa, aKeyField, axFieldSelected, condition)
                                                                    .then(atestCehcka => {
                                                                        ...
                                                                        if (atestCehcka === 1) { DevExpress.ui.dialog.alert(aTravelEnAlert01, "INPUT ERROR"); }
                                                                            ...
                                                                            let result = DevExpress.ui.dialog.confirm("Are you sure you want to confirm (" + aaCheckOverseas + ") & send mail to " + aaHODAppName + " (" + aaHODAppEmail + ") ? <br><p style='color:Red; font-size: 12px;' ></b></p><p style='color: grey; font-size: 10px;'>(" + (xxChkLenxx) + ")</p>", "CONFIRM TO HOD"); // "<br>กด 'YES' เพื่อ֡บันทึก" +
                                                ...
                                                const aPopUpUpLoad = (aRefNoForName) => {
                                                    $(() => {
                                                        ...
                                                        const aauploader = $("#fileUploader").dxFileUploader({
                                                            ...
                                                            uploadUrl: `${aaPFDMI}/temp/uploads"`, //"https://cbsdev2.locktonwattana.com/temp/uploads",
                                                        });
