                            ...
                            .then(acData => {
                                ...
                                fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(aFullBody) }), redirect: "follow" })
                                    ...
                                    .then(hData => {
                                        ...
                                        var asEROCheck03 = false; //BOOKING                                       
                                                ...
                                                },
                                                {
                                                    ...
                                                    buttons: [
                                                        ...
                                                        },
                                                        {
                                                            hint: "Print",
                                                            icon: "fas fa-print",
                                                            visible: (aMMaMx === "faSupervisor" || aMMaMx === "admin"),
                                                            // visible: function (e) {
                                        ...
                                        const aPopUpAddForm = (aRecNo, iData, idDate, iView) => {
                                            ...
                                            $(() => {
                                                ...
                                                $("#Add-popupexit").dxButton({
                                                    ...
                                                    text: ((aMMaMx === "faSupervisor" || aMMaMx === "admin") && aViewG ? "SAVE & EXIT" : "EXIT"),
                                                    visible: true,
                                                    onClick: function (e) {
                                                        $("#gridContainer").dxDataGrid("instance").refresh();
                                                            ...
                                                            tabs: [
                                                                ...
                                                                },
                                                                {
                                                                    ...
                                                                    items: [
                                                                        // {
                                                                        //     dataField: "EROCode06",
                                                                        //     label: { text: "Travel Agent" },
                                                                        //     editorType: "dxSelectBox", // Change to dropdown
                                                                        //     editorOptions: {
                                                                        //         width: 120,
                                                                        //         dataSource: aaSubGroup01, // Use the data array
                                                                        //         displayExpr: "AgentName", // Show Agent Name
                                                                        //         valueExpr: "AgentID", // Store Agent ID
                                                                        //         searchEnabled: true, // Enable search in dropdown
                                                                        //         placeholder: "Select an agent",
                                                                        //         onValueChanged: function (e) {
                                                                        //             let aResult = aSearch2json(aaSubGroup01, "AgentID", e.value);
                                                                        //             let xResult = aResult[0].AgentName === "OTHER" ? "" : aResult[0].AgentName
                                                                        //             var formInstance = $("#Add-form").dxForm("instance");
                                                                        //             formInstance.updateData("ERORefNo4", xResult);
                                                                        //         }
                                                                        //     },
                                                                        //     cssClass: "verylight-green",
                                                                        //     colSpan: 1
