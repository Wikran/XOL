                                ...
                                fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(aFullBody) }), redirect: "follow" })
                                    ...
                                    .then(hData => {
                                        ...
                                        */
                                        ...
                                        let chkMore = aaUsrN.toLowerCase() === "wikran" ? "ExpGroupCode = '" + aaERTYPE + "'" : "ExpGroupCode = '" + aaERTYPE + "' and " + "PayToCode = '" + asStaffID + "'" 

                                        var aqrFull = chkMore; //"ExpGroupCode = '" + aaERTYPE + "' and " + "PayToCode = '" + asStaffID + "'" // Department = asDepartment ?scopes based permission (View Only Login Name)  ExpensesCode LIKE aaOnInitAccCode
