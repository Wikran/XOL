//Other Expenses 500 Taxi & Per diem (P)
...
200	Fleet Card (F)
300	Medical (M)
400	Travel & Expenses (T)
500	Taxi & Per diem (P)
700	Gift & Entertain (G)
800	Travel Requisition [R]
*/
...
var aaERTYPE = "500" // Other 500 Taxi & Per diem (P)
            ...
            $(() => {
                ...
                LoadSQLData(isLocalHost(), aDatabasea, aKeyIDa, aKeyField, axFieldSelected)
                    .then(result => {
                        ...
                        var aaPFDMI = isLocalHost();
                        var aaXToX = localStorage["aaXXoX"];
                        var aaOnInitExpGroupCode = "500" //Taxi & Per diem (P)
                        var aaOnInitExpGroupDesc = "Per diem & Taxi"
                        var aaOnInitAccCode = "Taxi & Per diem"
