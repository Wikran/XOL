...
//aaSubGroup01[aaSubGroupNM01
//import { aaSubGroup01 , aaSubGroupNM01 } from 'MasterData.js';
...
/*
        var aMulSet01 =  {
            ...
            aRHeight: 60,
            aFHeight: 30,
            aHeader: ["NO","Bill No", "Bill Date","Description","Purpose","Company/Personal Name","Type Of Reimbursement","Expenses Code", "Original Currency","Currency","X-Rate","Reimburse"],
            aWidth : [40,50,100,100,100,100,120,50,85,60,40,85],
            aFType : ["string","string","date","string","string","string","string","string","number","string","number","number"],
            aVisible: [1,1,1,1,1,1,1,0,1,1,1,1],
            aFooter: ["","","","","","","","","","","","sum"],
            aFLabel: "TOTAL"
        }        
        //console.log(aMulSet01.aTableFontSize)
        //console.log(aMulSet01.aHeader[0])
        //console.log(aMulSet01.aWidth[0])
        //console.log(aMulSet01.aFType[0])
        ...
        var aMulSet02 =  {
            ...
            aRHeight: 30,
            aFHeight: 30,
            aHeader: ["DC", "ExpensesCode","EAccDesc","Division", "DRAMT", "CRAMT"], //,"HeadRefNo","TAccDesc"
            aWidth : [40,50,100,165,100,100],
            aFType : ["string","string","string","string","number","number"],
            aVisible: [1,1,1,1,1,1],
            aFooter: ["","","","","sum","sum"],
            aFLabel: "BALANCE"
        }
        /*
        ...
        // Encrypting the network payload response using AES-256
        const networkPayload = 'This is a secret message.';
        const encryptionKey = crypto.randomBytes(32);
        const iv = crypto.randomBytes(16);
        const cipher = crypto.createCipheriv('aes-256-cbc', encryptionKey, iv);
        let encrypted = cipher.update(networkPayload, 'utf8', 'hex');
        encrypted += cipher.final('hex');
        console.log(encrypted, encryptionKey.toString('hex'), iv.toString('hex'));
        */

var aaXToX = localStorage["aaXXoX"];
var aaERTYPE = "100" // Other
...
/*
        function aGetDataAPI(aDMZServer, aFullTableName, aFieldSelected, aOBJsName) {
            ...
            //return 1 //return response.json();
        }
 
        function aGetD2V(aDMZServer, aFullTableName, aFieldSelected, aOBJsName) {
            let aLocalSQLToken = "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232"; // with select command
            let aLocalNonQueryToken = "9DE8BDB8-8EE0-48D0-A506-9AD24F151F9A"; // no select command
            let aaXPUB = "A75FCC75-8FB6-4460-B3F6-7070B4437930"; //Public Key
...
function alSChk(aObjName) {
    if (localStorage.getItem(aObjName) !== null) {
        console.log("success");
    } else {
        setTimeout(alSChk(aObjName), 3000);
    }
}
...
/*
                function aGenPDF4HTML() {
                    ...
                    /*<script src='https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.5.3/jspdf.min.js'></scrip> 
                    // Step 2: Create a new instance of the jsPDF object
                    var doc = new jsPDF();
                ...
                function generateTableXX(data, aMSetup) {
                    ...
                    var aaHHeight = aMSetup.aHHeight;
                    var aaRHeight = aMSetup.aRHeight;
                    var aaFHeight = aMSetup.aFHeight;
                    var aaFLabel = aMSetup.aFLabel;
                    var table = "<table  style = 'border: 1px solid grey; border-collapse: collapse; font-size: " + aTableFontSize + ";'><tr  style = 'border: 1px solid grey; border-collapse: collapse;'>";
                    ...
                    header.forEach(function (column) {
                        aHeaderLabel = aMSetup.aHeader[aHCol];
                        aaVisible = aMSetup.aVisible[aHCol]
                        aaWidth = aMSetup.aWidth[aHCol]
                        if (aaVisible === 1){
                           table += "<th style = 'width: " + aaWidth + "px; height: " + aaHHeight + "px; background-color: black; color: white; border: 1px solid grey; border-collapse: collapse;'>" + aHeaderLabel + "</th>";
                        }
                        aHCol += 1;
                    });
                    table += "</tr>";
                    ...
                    data.forEach(function (row) {
                        aHCol = 0;
                        table += "<tr style = ' height: " + aaRHeight + "px; border: 1px solid grey; border-collapse: collapse;'>";
                        header.forEach(function (column) {
                            aaType = aMSetup.aFType[aHCol]
                            aaVisible = aMSetup.aVisible[aHCol]
                            aaWidth = aMSetup.aWidth[aHCol]
                            aaFooter  = aMSetup.aFooter[aHCol]
                            //console.log(aHCol , aaType , (aaType === "number"))                    
                            if (aaVisible === 1) {
                                if (aaType === "number"){
                                    aValueD = row[column].toLocaleString('en-US', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2,
                                    useGrouping: true
                                    });
                                    if (aaFooter === "sum"){
                                        aaNumberV = +row[column];
                                        //console.log(typeof row[column], typeof aaNumberV, aaNumberV)
                                        if (aaSum[aHCol] === undefined) { aaSum[aHCol] = 0; } 
                                        //console.log(aaSum[aHCol], typeof aaSum[aHCol])
                                        aaSum[aHCol] += aaNumberV;
                                        
                                        aaColspan[aHCol] = aHCol
        
                                    }
                                    aRL = "float: right;" //"margin-right: " + aaFLen + "px;"
                                } else if (aaType === "date"){
                                    aaDate = new Date(row[column]);
                                    aaformattedDate = aaDate.toLocaleDateString("en-GB", {
                                        day: "2-digit",
                                        month: "2-digit",
                                        year: "numeric"
                                    });                        
                                    aValueD = aaformattedDate //.replace(/\//g, "-");
                                } else {
                                    aValueD = row[column]
                                    aRL = "margin-left: 5px;"
                                }
                                table += "<td style = 'border: 1px solid grey; border-collapse: collapse;'><div style = '" + aRL + "'>" + aValueD + "</div></td>";
                            }
                            aHCol += 1;
                        });
                        table += "</tr>";
                    ...
                    //console.log(aaSum, aaColspan, aaSum.length)
                    table += "<tr style='height: " + aaFHeight + "px;'><td><div style = 'font-weight:bold; margin-left: 20px;'>"+ aaFLabel +"</div>" //<div style = 'float: right;'>" + aValueD + "</div></td></tr>"
                    for (let i = 0; i < aaSum.length; i++) {
                        if (aaSum[i] !== undefined){
                            console.log(aaSum[i], aaColspan[i]);
                            table += "<td colspan='" + aaColspan[i] + "'><div style = 'font-weight:bold; float: right;'>" + aaSum[i].toLocaleString('en-US', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2,
                                    useGrouping: true
                                    }); + "</div></td>"
...
// }
/**
 * Get next ID (ISNULL(MAX(ID),0)+1) for a given HeadRefNo from a table.
 * @param {string} aTableName - e.g., "REQDEC"
 * @param {string} aaPFDMI    - API server base URL
 * @param {string} axRunRun   - HeadRefNo value to filter by
 * @returns {Promise<number>} - resolves to NextID
 */
function getNextId(aTableName, aaPFDMI, axRunRun, NextNum) {
    // 1) Validate table name to avoid injection
    const tableOk = /^[A-Za-z0-9_\.]+$/.test(aTableName);
    if (!tableOk) return Promise.reject(new Error('Invalid table name.'));

    // 2) Quote/escape HeadRefNo for SQL
    const esc = s => String(s).replace(/'/g, "''");
    const headRef = esc(axRunRun);
    const numfornext = NextNum

    // 3) Build SQL (schema optional; add dbo. if you always use it)
    // NextID derived from count (optionally add an offset via numfornext)
    const aSQL = `SELECT COUNT(*) + ${numfornext} AS NextID FROM ${aTableName} WHERE HeadRefNo = N'${headRef}'`;

    //const aSQL = `SELECT ISNULL(MAX(ID), 0) + ${numfornext} AS NextID FROM ${aTableName} WHERE HeadRefNo = N'${headRef}'`;

    // 4) Build URL (uses aaXToX from your environment)
    ...
    return fetch(aURL, {
        ...
        .then(aData => {
            if (!Array.isArray(aData) || !aData[0] || aData[0].NextID == null) {
                throw new Error('No valid NextID returned.');
            }
            const nextId = Number(aData[0].NextID);
            if (!Number.isFinite(nextId)) throw new Error('NextID is not numeric.');
            return nextId;
        });
}
...
//let aNowDte = new Date() // FIRST PRG
showPreviousYearPopup(function (aNowDte) {
    ...
    var aaPFDMZz = "https://cbsdev2.locktonwattana.com"; //"https://cbsdev2.locktonwattana.com"; // API for DMZ only
    //aaPFDMI = aaPFDMZz
            ...
            $(() => {
                ...
                LoadSQLData(isLocalHost(), aDatabasea, aKeyIDa, aKeyField, axFieldSelected)
                    .then(result => {
                        ...
                        //aaPFDMI = aaPFDMZz
                        //var aCurrenciesList = aObjects.aCurrenciesList;
                        var aaXToX = localStorage["aaXXoX"];

                        var aaOnInitExpGroupCode = "100"
                        var aaOnInitExpGroupDesc = "Other"
                        var aaOnInitAccCode = "55101150003"
                        var aaOnInitAccDesc = "Other"
                        //var acData;
                            ...
                            .then(acData => { //});
                                ...
                                fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(aFullBody) }), redirect: "follow" })
                                            ...
                                            columns: [
                                                    ...
                                                    buttons: [
                                                        {
                                                            ...
                                                            onClick: function (e) {
                                                                let result = DevExpress.ui.dialog.confirm("Are you sure you want to Un-Confirmed to Edit this Record ? <br> ��й�����������ҧ��ô��Թ��õ�Ǩ�ͺ����͹��ѵԢͧ �س" + e.row.data.Vendor02Note + " <br><p style='color:Red; font-size: 12px;' > ��سҵ�Ǩ�ͺ����ͺ�ͺ��͹��ô��Թ��õ�� <br><b><u>����蹹��</u> �Ҩ�Դ��üԴ��Ҵ㹢�鹵͹��â�͹��ѵ��� </b></p><p style='color: grey; font-size: 10px;'></p>�׹�ѹ�������", "UN-CONFIRMED ?"); // "<br>�� 'YES' ���ͺѹ�֡" +
                                                                result.done(function (dresult) {
                                                                    if (dresult) {
                                                                        ...
                                                                        //let aMessage01 = "<div>���¹ �س" + $.trim(aApproverName) + "<br>Please noted that " + aaOnInitExpGroupDesc + " Expenses for REFNO = [" + e.row.data.HeadRefNo + "]<br> at (" + aAddress2Do + "). has un-confirmed <br><br>Regards,<br>" + aRequesterName + "</div>"
                                                                        let aMessage01 = "<div>���¹ �س" + $.trim(aApproverName) + "<br>����͹��ѵ������¡������ " + aaOnInitExpGroupDesc + " Expenses Reimbursement ����Ѻ REFNO = [" + e.row.data.HeadRefNo + "]<br> ��Ѻ���� <br> ��ҹ�������� " + aAddress2Do + "<br><br><br><b>" + aRequesterName + "</b></div>"
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            onClick: function (e) {
                                                                ...
                                                                //send Email
                                                                let aaMailTitle = aaOnInitExpGroupDesc.toUpperCase() + " EXPENSES REIMBURSEMENT <br> Request For Approve";
                                                                let aApproverName = aaHODAppName + ", [HOD]"     //aaHRAppName //"Wikran" + " [HOD]"         // HOD Approver Name
                                                                let aApproverEmail = $.trim(aaHODAppEmail)      // aaHRAppEmail //"wikran@asia.lockton.com" // HR Approver
                                                                let aRequesterName = asFullName //e.data.PayToName //"Wikran Intaraprajaks"
                                                                let aRequesterEmail = asStaffEmail //e.data.ERODesc06 //"wikran@asia.lockton.com"
                                                                let aSubject = aaOnInitExpGroupDesc + " Expewnses Reimbursement - Request For Approve"
                                                                let aAddress2Do = "<a href='" + aaPFDMI + "/XOL/index.html'>Expenses Reimburse</a>"; //<a href='https://www.w3schools.com'>Visit W3Schools</a>
                                                                let aMessage01 = "<div>���¹ �س" + $.trim(aApproverName) + ",<br>Please verify and approve " + aaOnInitExpGroupDesc + " Expenses for REFNO = [" + e.row.data.HeadRefNo + "]<br> at (" + aAddress2Do + "). <br><br>Regards,<br>" + aRequesterName + "</div>"
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            onClick: function (e) {
                                                                ...
                                                                let aSubject = "Please approve Other Expenses Reimbursement"
                                                ...
                                                },
                                                {
                                                    ...
                                                    /*setCellValue: function (newData, value, currentRowData) {
                                                        ...
                                                        let aaCheckAmt = aaTotal - (aaTTAmt + value)
...

                                                {
                                                    ...
                                                    /*setCellValue: function (newData, value, currentRowData) {
                                                        ...
                                                        if ($.trim(value) === "Travel & Entertainment") {
                                    ...
                                    },
                                    {
                                        ...
                                        const aPopUpAddFormOT = (aRecNo, iData, idDate) => {
                                            var aaPFDMI = isLocalHost();
                                            var astr = localStorage["aDXTheme"]
                                            if (aRecNo === 1) {
                                                var aaaTitle = " [ADD]"
                                                ...
                                                */
                                                    ...
                                                    onClick: function (e) {
                                                        ...
                                                        fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(aFullBodyxx) }), redirect: "follow" })
                                                            ...
                                                            .then(ppData => {
                                                                ...
                                                                // aaHODAll4Chk save to Vendor01Note
                                                                // 
                                                                /*
                                                                console.log(nnLno)
                                                                console.log(aaHODApprover[nnLno].LRange02)
                                                                console.log(aaHODApprover[nnLno].ApproverName)
                                                                console.log(aaHODApprover[nnLno].ApproverEmail)
                                                                console.log(aaHODAll4Chk)
                                                                console.log(aaHODAll4Chk.replaceAll("|", '"'));
                                                                */
                                                                /*
                                                                var aatestChk = aaHODAll4Chk.replaceAll("|", '"')
                                                                
                                                                var xxChk1;
                                                                var xxChk2;
                                                                var xxChk3;
                                            
                                                                xxChk1 = aatestChk.search("NAME:")
                                                                xxChk2 = aatestChk.search("MAIL:")
                                                                xxChk3 = aatestChk.search("RANG:")
                                                                console.log(xxChk1, xxChk2, xxChk3)
                                                                //console.log(aatestChk.substr(xxChk1+5, xxChk2-5))
                                                                var xaChkName = aatestChk.substr(xxChk1+5, xxChk2-xxChk1-5);
                                                                
                                                                //console.log(aatestChk.substr(xxChk1+5, xxChk2-xxChk1-5));
                                                                //console.log(aatestChk.substr(xxChk3+5, xxChk3+100))
                                                                ...
                                                                */
                                                                ...
                                                                let result = DevExpress.ui.dialog.confirm("Are you sure you want to confirm & send mail to " + aaHODAppName + " (" + aaHODAppEmail + ") ? <br><p style='color:Red; font-size: 12px;' > ��� ��سҵ�Ǩ�ͺ��úѹ�֡��¡�����ú�ء��ͧ㹷ء��÷Ѵ** <br><b><u>����蹹��</u> �з������¡�ù���ԡ��������� </b></p><p style='color: grey; font-size: 10px;'>(" + (xxChkLenxx) + ")</p>", "CONFIRM TO HOD"); // "<br>�� 'YES' ���ͺѹ�֡" +
                                                                result.done(function (dresult) {
                                                                    if (dresult) {
                                                ...
                                                $("#Add-dxDataGrid").dxDataGrid({
                                                    ...
                                                    columns: [
                                                        ...
                                                        {
                                                            /*
                                                                let aObjKeyData = { REFNO: axLineNo, ID: aaID, LocalAmount: 0, Amount: 0, RefundedAmount: 0,Note: "", ERORefNo1: "", ERORefNo3: "", ERORefNo4: "", ERODesc02: "", ERODesc03: "", ERODesc04: "",ExpensesCode: "", Currency: "", Xrate: 0}
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            setCellValue: function (newData, value, currentRowData) { //, componentInstance
                                                                console.log(value);//alligatorFacts.indexOf("soft and fluffy");
                                                                //aaSubGroup.filter(function (aaFoundArr) { return aaFoundArr.ExpSubGroup == value });
                                                                //console.log(aaSubGroupNM.indexOf(value))
                                                                //console.log(aaSubGroup[aaSubGroupNM.indexOf(value)].ACCCode)
                                                                newData.ERORefNo3 = value;
                                                                //console.log(aaSubGroup.ACCCode);
                                                                newData.ExpensesCode = (aaSubGroup01.find(item => item.TDESC === value)?.ACCCODE);
                                                                //newData.ExpensesCode = aaSubGroup01[aaSubGroupNM01.indexOf(value)].ACCCode

                                                                /*if ($.trim(value) === "Local Travel") {
                                                                    newData.RefundedAmount = 0;
                                                                    newData.NeedPayment = false; //(value = "Fleet Card" ? false : true);
                                                                    newData.EROCheck01 = true;
                                                                    newData.EROCheck02 = true;
                                        ...
                                        function aPopUpAddForm(aRecNo, iData, idDate) { // popup Add New
                                            ...
                                            jQuery(function ($) {
                                                ...
                                                */
                                                ...
                                                var gbxRateV = 1;
                                                const popup = $("#popupContainerAdd").dxPopup({
                                                    title: "Other Expenses Reimbursement" + aaaTitle,
                                                    width: '1300px',
                                                    position: { offset: "0 -140" }, //{offset: "0 -180"},
                                                    //position: {offset: "40 -200"}, //{my:"top", at:"top", of:window},
                                                    visible: true,
                                                                ...
                                                                */
                                                                ...
                                                                result.done(function (dresult) {
                                                                    if (dresult) {
                                                                        ...
                                                                        //let aTrueORFalse = (e.row.data.Confirmed === true ? '0' : '1');
                                                                        //let aTrueORFalseB = (e.row.data.Confirmed === true ? false : true);
                                                                        var aObjKeyData = { REFNO: aFREF, Confirmed: aTrueORFalseB, ERStatus: aERStatus, ReqDate: new Date() };
                                                                        var aObjRowData = JSON.stringify($.extend({}, iData, aObjKeyData));
                                                                        //sendRequestNew("Update", aObjRowData, aaTBKey, aaPFDMI, atob(aaXToX));  // Update the ID = 1 of REFNO

                                                                        //use ExtraOnLine; UPDATE EXPREIM  SET Confirmed = 1 Where HeadRefNo = 'M2108063704'
                                                                        //let aSQLCommand = "use ExtraOnLine; UPDATE EXPREIM  SET Confirmed = " + aTrueORFalse + ", ERORefNo6 = '" + aaHODAppEmail + "', ERStatus = '" + aERStatus + "' Where HeadRefNo = '" + aaiHeadRef + "'"
                                                ...
                                                const aform = $("#Add-form").dxForm({
                                                    ...
                                                    items: [{
                                                        ...
                                                        {
                                                            dataField: "PayToName",
                                                            label: { text: "Pay To", }, // template: labelTemplate("user"),
                                                            dataType: "string",
                                                            editorType: "dxTextBox",
                                                ...
                                                $("#Add-dxDataGrid").dxDataGrid({
                                                    ...
                                                    columns: [
                                                                ...
                                                                */
                                                                {
                                                                    ...
                                                                    onClick: function (e) {
                                                                        ...
                                                                        var aExitMessage = "All rows of this Reimbursement have deleted !!";
                                                                        var aFrecN = e.row.data.ID;
                                                                        var aaaHeadRefNO = e.row.data.HeadRefNo;
                                                                        if (aFrecN === 1) {
                                                                            aLocalMess = "<div style='color:Tomato; font-size: 16px'><center><b>THIS IS THE FIRST ROW (NO = 1)</b><br>If you delete first row, program will delete all rows [REFNO = <u>" + e.row.data.HeadRefNo + "</u>]</div> <br> Are you sure you want to delete all rows ?"
                                                                            aLocalTitle = "DELETE ALL ROWS"
                                                                        } else {
                                                                        ...
                                                                        result.done(function (dresult) {
                                                                            if (dresult) {
                                                                                ...
                                                                                if (aFrecN === 1) {
                                                                                    ...
                                                                                    const refnoRaw = e.row.data.REFNO;           // e.g., "M2108168624-003"
                                                                                    const refno = esc(refnoRaw);
                                                                                    //alert("this refno " + refno)
                                                                                    const deleteCmd = `
                                                                                            USE ExtraOnLine;
                                                                                            DELETE FROM EXPREIM WHERE REFNO = N'${refno}';
                                                                                            `;

                                                                                    aSQLCommand = deleteCmd;
                                                                                    aSQLAction(aaPFDMI, aSQLCommand);
                                                                                    //aSQLAction(aaPFDMI, aSQLCommand, () => {
                                                                                    // 2) Compute prefix and deletedId from the original REFNO
                                                                                    const prefix = refnoRaw.slice(0, -4);                 // "M2108168624"
                                                                                    const deletedId = parseInt(refnoRaw.slice(-3), 10);   // 3
                                                                                    
                                                                                    //alert(`start change ID from ID = ${deletedId + 1}`)
                                                                                    // 3) Get last ID (as NextID = MAX(ID)+1) for this HeadRefNo
                                                                                    // NOTE: getNextId signature: (aTableName, aaPFDMI, axRunRun)
                                                                                    getNextId('EXPREIM', aaPFDMI, aaaHeadRefNO, 0)
                                                                                        .then(anextId => {
                                                                                            //alert(`last ID = ${anextId}`); // NextID = lastId + 1

                                                                                            //const axlastId = Number(anextId); // true last existing ID after delete
                                                                                            //const headRefEsc = esc(aaaHeadRefNO);
                                                                                            
                                                                                            // 4) Renumber each remaining row: oldId -> newId (oldId-1)
                                                                                            //if (deletedId < anextId) {
                                                                                                //for (let oldId = deletedId + 1; oldId <= lastId; oldId++) {
                                                                                                // for (let arowNo = 2; arowNo <= axlastId; arowNo++) {    
                                                                                                //     const newId = arowNo; //- 1;
                                                                                                //     const oldRef = esc(`${prefix}-${String(arowNo).padStart(3, '0')}`);
                                                                                                //     const newRef = esc(`${prefix}-${String(newId).padStart(3, '0')}`);

                                                                                                //     alert(`arowNo = ${arowNo}, newId = ${newId}`)
                                                                                                    
                                                                                                //     const updateCmd = `
                                                                                                //             USE ExtraOnLine;
                                                                                                //             UPDATE EXPREIM
                                                                                                //             SET ID = ${newId}
                                                                                                //             WHERE HeadRefNo = N'${headRefEsc}' AND ID = ${oldId}`.trim();
                                                                                                //     //alert(updateCmd) SET ID = ${newId},REFNO = N'${newRef}' AND REFNO = N'${oldRef}'
                                                                                                //     aSQLCommand = updateCmd;
                                                                                                //     aSQLAction(aaPFDMI, aSQLCommand);
                                                                                                // }
                                                                                            //}
                                                                                            const totalRows = Number(anextId); // from getNextId
                                                                                            alert(totalRows)
                                                                                            if (totalRows > 1) {
                                                                                              for (let arowNo = 2; arowNo <= totalRows; arowNo++) {
                                                                                                const newId = arowNo;
                                                                                                const newRef = esc(`${prefix}-${String(newId).padStart(3, '0')}`);
                                                                                                //,
                                                                                                //            REFNO = N'${newRef}'
                                                                                                alert(`Loop: ${arowNo}, new ID = ${newId}, ID > ${newId -1}`)
                                                                                                const updateCmd = `
                                                                                                        UPDATE t
                                                                                                        SET ID = ${newId}
                                                                                                        FROM dbo.EXPREIM AS t
                                                                                                        JOIN (
                                                                                                            SELECT TOP (1) ID
                                                                                                            FROM dbo.EXPREIM
                                                                                                            WHERE HeadRefNo = N'${headRefEsc}'
                                                                                                            AND ID > ${newId - 1}  -- ensure we pick the "next" row in sequence
                                                                                                            ORDER BY ID ASC
                                                                                                        ) AS firstMatch
                                                                                                        ON t.ID = firstMatch.ID;
                                                                                                        `.trim();
                                                                                            ...
                                                                                            // 5) Refresh UI (optional)
                                                                                            const grid = $('#Add-dxDataGrid').dxDataGrid('instance');
                                                                                            grid.refresh();
                                                                                        })
                                                                                        .catch(err => {
                                                                                            console.error('Failed to get NextID:', err.message);
                                                                                        });
                                                                                    //});
                                                        ...
                                                        /*
                                                            let aObjKeyData = { REFNO: axLineNo, ID: aaID, RefundedAmount: 0,LocalAmount: 0, Amount: 0,AmountBeforeVAT: 0, VAT: 0,ERORefNo4: "", ERORefNo3: "", Note: "", ERORefNo1: "", ERORefNo3: "", ERODesc02: "",ERODesc03: "", Vendor01: "", ExpensesCode: "" }
                                                            let aObjRowData = JSON.stringify($.extend({}, e.row.data, aObjKeyData)); //values                            
                                                        */
                                                        {
                                                            type: "buttons",
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            setCellValue: function (newData, value, currentRowData) {
                                                                ...
                                                                newData.LocalAmount = value * (currentRowData.Xrate);
                                                                newData.RefundedAmount = value * (currentRowData.Xrate);
                                                                newData.AmountBeforeVAT = value * (100 / 107)
                                                                newData.VAT = value - (value * (100 / 107))
                                                            },
                                                            /*setCellValue: function (newData, value, currentRowData) {
                                                                let aaHeadRefNO = currentRowData.HeadRefNo
                                                                let aaTT = aGetD2V(aaPFDMI, "ExtraOnLine.dbo.ERnextIDview Where HeadRefNo LIKE '" + aaHeadRefNO + "%'", "TAmount", "aaOBJnnT")
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            setCellValue: function (newData, value, currentRowData) {
                                                                ...
                                                                if (value === 0) {
                                                                    newData.VAT = value
                                                                    newData.AmountBeforeVAT = currentRowData.Amount;
                                                                    newData.RefundedAmount = currentRowData.Amount;
                                                                    newData.LocalAmount = currentRowData.Amount;
                                                                }
                                                            },
                                                            editorOptions: { format: "#,##0.00", width: 100 },
                                                            width: 100,
                                                        ...
                                                        /*
                                                        {
                                                            dataField: "EROCheck01", //AmountBeforeVAT, VAT
                                                            caption: "Pay Slip",
                                                            dataType: "boolean",
                                                            width: 110,
                                                            visible: false,
