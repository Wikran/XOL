                                        ...
                                        items: [
                                            {
                                                ...
                                                items: [
                                                    ...
                                                    },
                                                    {
                                                            ...
                                                            contentTemplate: function (e) {
                                                                return $("<div>").dxDataGrid({
                                                                    dropDownOptions: {
                                                                        ...
                                                                        //   my: "top",
                                                                        //   at: "bottom",
                                                                        //   of: "#Add-formPRE", // or use e.element for dynamic positioning
                                                                        // }
                                                                    },
                                                                    dataSource: aObjects.CashAdvanceClient,
                                                                    //remoteOperations: true,
                                                                    columns: [
                                                                        ...
                                                                        { dataField: "CashAdvance", caption: "Limit", width: 80, format: "#,##0.000000" }
                                                                    ],
                                                                    //hoverStateEnabled: true,
                                                                    paging: { enabled: true, pageSize: 15 },
                                                                    searchPanel: { visible: true },
                                                                    ...
                                                                    //focusedRowKey: cellInfo.value,
                                                                    onSelectionChanged: function (sArgs) {
                                                                        gbxRateV = sArgs.selectedRowKeys[0].ClientCode
                                                                        e.component.option("value", sArgs.selectedRowKeys[0].ClientCode);
                                                                        if (sArgs.selectedRowKeys.length > 0) {
                                                                            e.component.close();
                                                                        }
                                                                    }
                                                        ...
                                                        //     valueExpr: "ClientCode",
                                                        //     displayExpr: "CompanyName",
                                                        //     searchExpr: ["CompanyName", "ClientCode", "CompanyGroup"],

                                                        //     itemTemplate: function (item) {
                                                        //         if (!item) return "";
                                                        //         const cash = DevExpress.localization.formatNumber(item.CashAdvance, { type: "fixedPoint", precision: 2 });
                                                        //         return `
                                                        //           <div style="display:flex; gap:10px;">
                                                        //             <div>${item.CompanyName}</div>
                                                        //             <div>[${cash}]</div>
                                                        //           </div>
                                                        //         `; //<div style="min-width:100px; color:#444;">Code: ${item.ClientCode}</div>
                                                        //     }, //<div style="min-width:90px; color:#666;">${fixedGName}</div>
                                                        //     searchEnabled: true,
                                                        //     width: 400,
                                                        //     onValueChanged: function (e) {
                                                        //         // store selected client code
