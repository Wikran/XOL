                            ...
                            .then(acData => { //});
                                ...
                                fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(aFullBody) }), redirect: "follow" })
                                    ...
                                    .then(hData => {
                                        ...
                                        let chkMore = aaUsrN.toLowerCase() === "wikran" ? "ExpGroupCode = '" + aaERTYPE + "'" : "ExpGroupCode = '" + aaERTYPE + "' and " + "EntryBy = '" + aaUsrN + "'"
                                        var aqrFull = chkMore; //"ExpGroupCode = '" + aaERTYPE + "' and " + "EntryBy = '" + aaUsrN + "'" //"PayToCode = '" + asStaffID + "'" //Department = asDepartment ?scopes based permission (View Only Login Name)  ExpensesCode LIKE aaOnInitAccCode
                                        ...
                                        $("#gridContainer").dxDataGrid({
                                            ...
                                            columns: [
                                                ...
                                                {
                                                    dataField: "PayToName",
                                                    caption:  "Associate Name",// template: labelTemplate("user"),
                                                    dataType: "string",
                                        ...
                                        const aPopUpChangeForm = (aRecNo, iData, idDate) => {
                                            ...
                                            $(() => {
                                                ...
                                                const popup = $("#popupChangeDivForm").dxPopup({
                                                    title: "Declaration Change Division" + aaaTitle,
                                                    width: '1400px',
                                                    height: '480px',
                                        ...
                                        function aPopUpAddForm(aRecNo, iData, idDate, iView) { // popup Add New
                                            ...
                                            $(() => {
                                                ...
                                                const aform = $("#Add-form").dxForm({
                                                    ...
                                                    items: [{
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            label: { text: "Status" },
                                                            editorType: "dxTextBox",
                                                            editorOptions: { readOnly: true, width: 250 }, //value: "Register", 
                                                        },
                                                        ]
                                                    },
                                                    ]
                                                ...
                                                $("#Add-dxDataGrid").dxDataGrid({
                                                    ...
                                                    onEditorPreparing: function (e) {
                                                        if (e.parentType === "dataRow" && arDataU === 0) {
                                                            ...
                                                            if (e.parentType === "dataRow" && (e.dataField === "EntryBy" || e.dataField === "EntryDate" || e.dataField === "ERStatus" || e.dataField === "PSPvNO" || e.dataField === "PSPvDate" || e.dataField === "LocalAmount" || e.dataField === "ReqDate" || e.dataField === "HeadRefNo")) {
                                                                e.editorOptions.disabled = true;
                                                            } //|| e.dataField === "Department" || e.dataField === "PayToCode" || e.dataField === "PayToName" 
                                                        }
                                                    },
                                                    onCellPrepared: function (e) {
                                                        if (e.rowType === "data") {
                                                    ...
                                                    columns: [
                                                        ...
                                                        }, // place paytocode
                                                        {
                                                            ...
                                                            editCellTemplate: dropDownBoxUSR,
                                                            width: 180,
                                                            //editorType: "dxTextBox",
                                                            setCellValue: function (newData, value, currentRowData) {
                                                                //newData.PayToName = aaDropdownData
                                                                //let nicknames = aaDropdownData.map(item => item.Nickname).join('\n');
                                                                //alert(nicknames);
                                                                //alert(aaDropdownData)
                                                                newData.PayToName = value;
                                                                let matchedItem = aaDropdownData.find(item => item.Nickname === value);

                                                                // //let matchingNicknames = aaDropdownData
                                                                //     .filter(item => item.Scopebase === value)
                                                                //     .map(item => item.Nickname)
                                                                //     .join('\n');
                                                                newData.PayToCode = matchedItem?.Scopebase
                                                                newData.Department = matchedItem?.Department
                                                                newData.Division = matchedItem?.Division
                                                                //alert(matchedItem?.Nickname);
                                                                //alert(matchedItem?.LGName);
                                                                //(matchedItem?.Department);
                                                                //(matchedItem?.Active);
                                                            },
                                                            editorOptions: { width: 180, elementAttr: { class: "custom-editor" } },
                                                        },
                                                        // {
                                                        //     dataField: "Scopebase",
                                                        //     caption: "Staff ID",
                                                ...
                                                function dropDownBoxUSR(cellElement, cellInfo) {
                                                    var aaTBKey = "01f518c9-c818-4e9f-85cb-6245ee1a2637" //Scopebase  IDUsr "5ad2685d-4114-4aa5-aa87-67368f4a3559";
                                                    const aqrFull = `Active = 1`;
                                                    ...
                                                    return $("<div>").dxDropDownBox({
                                                        ...
                                                        contentTemplate: function (e) {
                                                            return $("<div>").dxDataGrid({
                                                                ...
                                                                columns: [
                                                                    { dataField: "Scopebase", caption: "Staff ID", width: 90,  },
                                                                    //{ dataField: "Scopebase" }, { dataField: "Tkey" },
                                                                    { dataField: "Nickname", caption: "THAI Name",width: 120, sortOrder: "asc" },
                                                                    { dataField: "LGName", caption: "ENG Name", width: 120, }, 
                                                                    { dataField: "Department", caption: "Dept.", width: 120, }, { dataField: "Division", caption: "Div." , width: 120,},
                                                                ...
                                                                onSelectionChanged: function (sArgs) {
                                                                    ...
                                                                    if (selectedRow) {
                                                                        e.component.option("value", selectedRow.Nickname);
                                                                        cellInfo.setValue(selectedRow.Nickname);
