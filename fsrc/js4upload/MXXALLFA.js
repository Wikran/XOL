//    <script>
        ...
        var actionSheetItems = [
            ...
            { ID: "03", text: "LOGIN (OTP)           ", type: "normal", icon: "fas fa-lock", visible: false, onClick: function () { aRunLogin(1) } },
            { ID: "04", text: "LOGIN (Other user)    ", type: "normal", icon: "fas fa-key", visible: true, onClick: function () { aRunLogin() } },
            { ID: "05", text: "LOGOUT                ", type: "danger", icon: "fas fa-sign-out-alt", visible: true, onClick: function () { aaLOGOUT() } },
            { ID: "06", text: "THEMES                ", type: "normal", icon: "fas fa-palette", visible: true, onClick: function () { aThemeSelect() } }
        ...
        */
        ...
        const arSTATUS = ["Waiting For Document", "Please contact back asap", "Reimbursement Denined"];
        const arSTANOTE = ["��س����͡��������ú���͵�Ǩ�ͺ", "��سҵԴ��͡�Ѻ�´�ǹ", "��â��Թ�׹�������ö����"]
...
var aqrFull = "ERStatus LIKE '" + asERStatus + "' OR ERStatus LIKE '" + asERAppSta + "'" //" and Division IN " + aHODDivGrp  // scopes based permission (View Only Login Name)  ExpensesCode LIKE aaOnInitAccCode Division "ExpGroupCode LIKE '%" + aaERTYPE + "%' and " +
...
$(() => {
    ...
    */
    ...
    $("#gridContainer").dxDataGrid({
        ...
        filterValue: [['ReqDate', '>=', aFilterT], "and", ['ReqDate', '<=', aFilterT2] , "and", ['HeadRefNo', 'notcontains', 'BF']],  //     [Req.Date] Is any of('2022')    And [REF NO] Does not contain 'BF'              
        grouping: {
            autoExpandAll: true,
        },
        searchPanel: {
            ...
            $('#aAgentPivot').dxPivotGrid({
                ...
                onExporting(e) {
                    ...
                    DevExpress.excelExporter.exportPivotGrid({
                        ...
                        headerCell.value = 'Renewal by Staff Name';
