...
const aaPurposeTable = [
    { "Purpose": "Conference", "TPurpose": "ประชุม" },
    { "Purpose": "Training", "TPurpose": "อบรม" },
    { "Purpose": "Traveling", "TPurpose": "การเดินทาง" },
    //{ "Purpose": "Others", "TPurpose": "อื่นๆ" }
]
const aaPurposeTableaa = [
    { "Purpose": "Conference", "TPurpose": "ประชุม" },
    { "Purpose": "Training", "TPurpose": "อบรม" },
    { "Purpose": "Traveling", "TPurpose": "การเดินทาง" },
    { "Purpose": "Client visit", "TPurpose": "เยี่ยมลูกค้า" },
    { "Purpose": "Product launch", "TPurpose": "เปิดตัวผลิตภัณฑ์" },
    { "Purpose": "Site visit", "TPurpose": "ศึกษาดูงาน" },
    { "Purpose": "Negotiation", "TPurpose": "เจรจาต่อรอง" },
    { "Purpose": "Troubleshooting", "TPurpose": "แก้ไขปัญหา" },
    { "Purpose": "Exhibition", "TPurpose": "เข้าร่วมงานแสดงสินค้า" },
    { "Purpose": "Market research", "TPurpose": "วิจัยตลาด" },
    { "Purpose": "Others", "TPurpose": "อื่นๆ" }
]
const aaYesNoList = [
    { "Code": "YES" },
                        ...
                        fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(axFullBody) }), redirect: "follow" })
                            ...
                            .then(acData => {
                                ...
                                fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(aFullBody) }), redirect: "follow" })
                                    ...
                                    //
                                    .then(hData => {
                                        // const aaHRArr = hData.find(item => item.ApproverCode === 'HR');
                                        //console.log("HR = ",aaHRArr);
                                        var aaaHODApprover = hData; // HR Approver
                                        //console.log("hData HR or FA ",aaaHODApprover)
                                        ...
                                        //console.log("ARR ", aaaHODApprover)
                                        //const FAresult = aaaHODApprover.find(item => item.ApproverCode === 'FA');
                                        //console.log(FAresult)
                                        //console.log("FA 1 ", aaaHODApprover[1])
                                        //console.log("HR 0 ", aaaHODApprover[0])
                                        var aaHODApprover = aaaHODApprover.find(item => item.ApproverCode === 'HR'); //= aaaHODApprover[1]
                                        var aaFAApprover = aaaHODApprover.find(item => item.ApproverCode === 'FA'); //aaaHODApprover[0]
                                        ...
                                        //console.log("HR:", aaHODAppName, aaHODAppEmail, "FA:", aaFAAppName, aaFAAppEmail)
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        template: function () {
                                                            return $("<div />")
                                                                //.addClass("informer")
                                                                .append(
                                                                    $("<span style='font-size: 13px; font-weight: bold; color: white; background-color: darkblue; border-radius: 3px; border: 0px; padding: 1px 30px; ' />")
                                        ...
                                        const aPopUpPrintForm = (iData, aaHeadRefNo) => { //, eData, acData
                                            ...
                                            $(() => {
                                                ...
                                                const popup = $("#popupContainer").dxPopup({
                                                    ...
                                                    //.text("��?�? �?��� ����?��??�?��?�� | Please attach the receipt with this document."),   
                                                ...
                                                const aAddStaff = $("#Add-dxDataGrid").dxDataGrid({
                                                    ...
                                                    customizeColumns: function (columns) {
                                                        columns.forEach(function (column) {
                                                            ...
                                                            if (column.caption === "ROAMING INFORMATION") { //ROAMING INFORMATION HR Arrange for Roaming
