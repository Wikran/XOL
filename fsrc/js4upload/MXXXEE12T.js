                                                                                ...
                                                                                if (atestCehcka === 1) { DevExpress.ui.dialog.alert(aVARs.ALERT01, "INPUT ERROR"); }
                                                                                    ...
                                                                                    result.done(function (dresult) {
                                                                                        if (dresult) {
                                                                                            ...
                                                                                            var aObjKeyData = { REFNO: aFREF, Confirmed: aTrueORFalseB, HODApproved: aTrueORFalseB, ERStatus: aERStatus, ReqDate: aNowDte };
                                                                                            var aObjRowData = JSON.stringify($.extend({}, iData, aObjKeyData));

                                                                                            let aSQLCommand = "use ExtraOnLine; UPDATE EXPREIM  SET Confirmed = " + aTrueORFalse + ", HODApproved = " + aTrueORFalse + ", Vendor01Note = '" + aaHODAll4Chk + "', Vendor02Note = '" + aaHODAppName + "', ERORefNo6 = '" + aaHODAppEmail + "', ERStatus = '" + aERStatus + "', ReqDate = '" + aNowDateT + "' Where HeadRefNo = '" + aaiHeadRef + "'"
                                                                                            aSQLAction(aaPFDMI, aSQLCommand) // Update Confirmed for all HeadReNo
                                                                                            aSQLAction(aaPFDMI, aSQLCommand)
                                                                                            aSQLAction(aaPFDMI, aSQLCommand)
                                                                                            $("#gridContainer").dxDataGrid("instance").refresh();
                                                                ...
                                                                },
                                                                {
                                                                    ...
                                                                    setCellValue: function (newData, value, currentRowData) {
                                                                        ...
                                                                        if (selectedItem) {
                                                                            ...
                                                                            newData.ERODesc03 = aaPurposexx + " ," + "TRF#[" + aaTRFNO + "]," + (aaOverseasxx ? "Overseas" : "Local") + ", Destination = " + aaDestinationxx + " / " + aaPurposeDescxx; //ERODesc02
