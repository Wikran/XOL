...
const [axfirstName, axlastName] = localStorage["asFTNAME"].split(" ");
    ...
    LoadSQLData(isLocalHost(), aDatabasea, aKeyIDa, aKeyField, axFieldSelected)
        .then(result => {
            ...
            function getResponse(input) {
                ...
                //let getvalues = { aServer: aaPFDMI, aaUsrN: aaUsrN, axfirstName: axfirstName, axlastName: axlastName, xt2vFleetCardHelp: aVARs.HELP01 }
