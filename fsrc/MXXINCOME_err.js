...
console.clear();
let aaHostName = window.location.href
let aaCheckON = aaHostName.includes("localhost")
let aaXToX = localStorage["aaXXoX"];
let aaERTYPE = "700" // Income
const aaRunPre = "G"

const aaLoadData = async (aaPFDMI, aDataBasea, aKeya, aKeyfield, axFieldSelected, condition) => {
    ...
    return filteredArray.length === 0 ? 0 : 1;
};

const aTranTextJson = (aText, aFMark, aLMark) => { //"NAME:" "EMAIL:"
    let axHODFtext = aText;
    let xaChkName;
    let aatestChk = axHODFtext.replaceAll("|", '"')
    let xxChk1 = aatestChk.search(aFMark);
    let xxChk2 = aatestChk.search(aLMark);
...
const showPreviousYearPopup = (callback) => {
    let today = new Date();
    let aTYear = new Date().getFullYear();
    let aLYear = aTYear - 1;
    let aNYear = aTYear + 1;
    let aTextThisYear = aTYear.toString() + "-" + aNYear.toString();
    let aTextLastYear = aLYear.toString() + "-" + aTYear.toString();
    let isAfterMay3 = (today.getMonth() === 4 && today.getDate() <= 3)
    if (isAfterMay3) {
        let options = [
            ...
            contentTemplate: function (contentElement) {
                $("<div>").dxList({
                    ...
                    onSelectionChanged: function (e) {
                        let selectedOption = e.addedItems[0];
                        if (selectedOption.id) {
                            let year = new Date().getFullYear();
                            let month = 3; // April is month 3 (zero-based)
                            let day = 30;
                            let aNowDte = new Date(year, month, day);
                        } else {
                            let today = new Date();
                            let aNowDte = new Date(); //let aNowDte = today.getDate() + "/" + (today.getMonth() + 1) + "/" + today.getFullYear();
                        }
                        popup.hide();
                        callback(aNowDte);
                    }
...
let aaPXIXD = localStorage["aPXIXD"];
let aaEnt = aaPXIXD.includes("X");
let aaUsrN = localStorage["aaXXuX"];
showPreviousYearPopup(function (aNowDte) {
    let aaPFDMI = isLocalHost();
    let afqrFull = "pageID='" + aaPXIXD + "' "
    let afURL = aaPFDMI + '/DMQ/XOL/' + atob(aaXToX) + '/' + "326459ff-7ea6-4465-a946-9326b783d492" + '/all' //+ aaPXXI
    let afsettings = {
        "url": afURL,
        "method": "POST",
        "timeout": 0,
    ...
    let jqxhr = $.post(afsettings, function (e) { })
        .done(function (e) {
            aObjMPage = e;
            let aaKeyField = aObjMPage[0].PrimaryKey;
            let aaTBKey = aObjMPage[0].TBKey;
    // let aaiHeadRef = ""; // Declare at the top
    // let aaaTitle = "";
    // $.post(afsettings)
    //     .done((e) => {
    //         aObjMPage = e;

    //         const [firstRecord] = aObjMPage;
    //         const aaKeyField = firstRecord?.PrimaryKey;
    //         const aaTBKey = firstRecord?.TBKey;
            $(() => {
                let aDatabasea = "ExtraOnLine.dbo.TaskControl";
                let aKeyField = "TaskGroup";
                let aKeyIDa = aaPXIXD; //"main"; //aaPXIXD;
                let axFieldSelected = "IDNO,TaskName,TaskProgram,TaskGroup";
                let condition = "TaskProgram";
                let aVARs = {};
                let aArrays = {};
                let aObjects = {};
                LoadSQLData(isLocalHost(), aDatabasea, aKeyIDa, aKeyField, axFieldSelected)
                    .then(result => {
                        ...
                        let aaOnInitExpGroupCode = "700"
                        let aaOnInitExpGroupDesc = "Gift&Entertain"
                        let aaOnInitAccCode = "4141000002" //"55101150003"
                        let aaOnInitAccDesc = "Sundry Income NON VATABLE" // "Other"
                            ...
                            .then(acData => { //});
                                ...
                                fetch(aaPFDMI + "/DMQ/XOL/" + atob(aaXToX) + "/" + "3DF65D9D-FEE8-4A8E-A01E-38C28F7B1232", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ "@": btoa(aFullBody) }), redirect: "follow" })
                                    ...
                                    .then(hData => {
                                        ...
                                        let aaHODRAnge02 = aaHODApprover[0].LRange02

                                        let aYearNum = aNowDte.getFullYear()  // 2022
                                        let aMonthNum = aNowDte.getMonth() // 10
                                        let aYearStr = aYearNum.toString() // 2022
                                        let aYearNumS = aNowDte.getFullYear()
                                        let aYearNumL = aNowDte.getFullYear()
                                        let aYearStrS = "";
                                        let aYearStrL = "";
                                        ...
                                        let aFilterT = aYearStrS + '/05/01'  //2022/05/01
                                        let aFilterT2 = aYearStrL + '/04/30'  //2023/04/01            
                                        let aMMaMx = atob(localStorage["aaXrXg"])
                                        let aRRgRs = aMMaMx.split('0');
                                        let aDDeDx = aRRgRs[0];
                                        let aRrgSx = aRRgRs[1];
                                        ...
                                        let nPDFPos = 3;
                                        let nRPTPos = 4;
                                        let arDataC = aRolesAction(aRrgSx, nDataPos, 1);
                                        let arDataU = aRolesAction(aRrgSx, nDataPos, 2);
                                        if (arDataU === 1) {
                                            let aUpdateText = "Update";
                                            let aSaveVisible = 1;
                                            let aCancelText = "Cancel";
                                            let aCancelicon = "close";
                                            let aCancelType = "danger";
                                        } else {
                                            let aUpdateText = "xxx";
                                            let aSaveVisible = 0;
                                            let aCancelText = "EXIT";
                                            let aCancelicon = "fas fa-sign-out-alt";
                                            let aCancelType = "success";
                                        }
                                        let arDataD = aRolesAction(aRrgSx, nDataPos, 3);
                                        let arExcelEx = aRolesAction(aRrgSx, nExcelPos, 2);
                                        let arPDFEx = aRolesAction(aRrgSx, nPDFPos, 2);
                                        ...
                                        let asDivision = localStorage["asDIV"];
                                        let asStaffEmail = localStorage["asEMAIL"];
                                        let aqrFull = "ExpGroupCode = '" + aaERTYPE + "' and " + "PayToCode = '" + asStaffID + "'" // Department = asDepartment ?scopes based permission (View Only Login Name)  ExpensesCode LIKE aaOnInitAccCode
                                        let aurl = aaPFDMI + '/DMQ/XOL/' + atob(aaXToX) + '/' + aaTBKey + '/all'
                                        let aSettings = { "url": aurl, "method": "POST", "timeout": 0, "headers": { "Content-Type": "application/json" }, "data": JSON.stringify({ "@": btoa(aqrFull) }), };
                                        let aaAllData;
                                        $("#gridContainer").dxDataGrid({
                                            dataSource: new DevExpress.data.CustomStore({
                                                ...
                                                insert: function (values) {
                                                    if (aaEnt) {
                                                        let ObjKeyData = { EntryBy: aaUsrN, EntryDate: new Date(), PayToCode: asStaffID, PayToName: asFullName, Department: asDepartment };
                                                        let ObjRowData = JSON.stringify($.extend({}, ObjKeyData, values));
                                                    }
                                                    else {
                                                        let ObjRowData = JSON.stringify(values);
                                                    }
                                                    sendRequestNew("Insert", ObjRowData, aaTBKey, aaPFDMI, atob(aaXToX));
                                                },
                                                update: function (key, values) {
                                                    let ObjKeyData = { "REFNO": $.trim(key) };   //[aaKeyField] key.trim
                                                    let ObjRowData = JSON.stringify($.extend({}, ObjKeyData, values));
                                                    sendRequestNew(aUpdateText, ObjRowData, aaTBKey, aaPFDMI, atob(aaXToX));
                                                },
                                                remove: function (key) {
                                                    let ObjKeyData = { "REFNO": $.trim(key) };   //[aaKeyField] key.trim
                                                    let ObjRowData = JSON.stringify($.extend({}, ObjKeyData));
                                            ...
                                            columns: [
                                                    ...
                                                    buttons: [
                                                        {
                                                            ...
                                                            onClick: function (e) {
                                                                let aSQLCommand = "";
                                                                let aLocalMess = "<div style='color:Tomato; font-size: 14px'><center><b> Are you sure you want to delete this record?"
                                                                let aLocalTitle = "DELETE"
                                                            ...
                                                            onClick: function (e) {
                                                                ...
                                                                result.done(function (dresult) {
                                                                    if (dresult) {
                                                                        ...
                                                                        let aObjKeyData = { REFNO: e.row.data.REFNO, Confirmed: aTrueORFalseB, ERStatus: aERStatus };   //[aaKeyField] key.trim
                                                                        let aObjRowData = JSON.stringify($.extend({}, e.row.data, aObjKeyData)); //value
                                                ...
                                                },
                                                {
                                                    ...
                                                    dataType: "string",
                                                    cellTemplate: function (container, options) { let text = options.value ? options.value.replace(/\n/g, "<br>") : ""; container.html(text); },
                                                    editorType: "dxTextArea",
                                                    width: 150,
                                                    height: 180,
                                                ...
                                                e.toolbarOptions.items.unshift(
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        options: {
                                                            ...
                                                            width: 140,
                                                            onClick: (e) => {
                                                                let expanding = e.component.option("text") === "Expand All";
                                        ...
                                        const aPopUpAddForm = (aRecNo, iData, idDate, iView) => { // popup Add New
                                            let aaPFDMI = isLocalHost();
                                            let astr = localStorage["aDXTheme"]
                                            let aViewF = (iView === undefined) ? false : iView;
                                            let aViewG = (iView === undefined) ? true : !iView;
                                            let anLimitAmt = 0;
                                            let asEROCode01 = "";
                                            ...
                                            if (aRecNo === 1) {
                                                ...
                                                let ObjRowData = JSON.stringify(ObjKeyData);
                                                sendRequestNew("Insert", ObjRowData, aaTBKey, aaPFDMI, atob(aaXToX));
                                            } else {
                                                let aaiHeadRef = aRecNo;
                                                let aaaTitle = (iView === undefined) ? " [EDIT]" : " {VIEW}"; //" [EDIT]"
                                                let aagiftItem = aObjects.aaLimitedAmt.find(item => item.code === iData.EROCode01);
                                                let aagiftAmount = aagiftItem ? aagiftItem.lmtamt : null;
                                                let anLimitAmt = aagiftAmount;
                                                let aformattedNumber = new Intl.NumberFormat('en-US', { minimumFractionDigits: 0 }).format(anLimitAmt);
                                                asEROCode01 = iData.EROCode01;
                                            }
                                            let aaSchRefx = "HeadRefNo LIKE '%" + aaiHeadRef + "%'" // (DataGrid View Only This New Item)
                                            aqrFull = aaSchRefx;
                                            let aaxurl = aaPFDMI + '/DMQ/XOL/' + atob(aaXToX) + '/' + aaTBKey + '/all'
                                            let aaxSettings = { "url": aaxurl, "method": "POST", "timeout": 0, "headers": { "Content-Type": "application/json" }, "data": JSON.stringify({ "@": btoa(aqrFull) }), };
                                            $(() => {
                                                let aaLastLineNo = 1;
                                                let aXXData = function () { return $.post(aaxSettings).done(); }
                                                if (iData === 1) {
                                                    iData = aXXData[0];
                                                }
                                                let gbxRateV = 1;
                                                ...
                                                $("#aConfirm").dxButton({
                                                    ...
                                                    onClick: function (e) {
                                                        ...
                                                        let aaTotalReim = 30000; //aaTotalValue[0].TotalReimburse                                                              
                                                        let aaiFoundApp = false;
                                                        let nnLno = 0;
                                                        let nnAdno = 0;
                                                        let aaHODEmail4Chk = ""; //aaHODAppName
                                                        let aaHODName4Chk = "";
                                                        let aaHODRange4Chk = "";
                                                        ...
                                                        let aDatabasea = "ExtraOnLine.dbo.GIFTREC";
                                                        let aKeyField = "HeadRefNo";
                                                        let aKeyIDa = aaiHeadRef //  T2408177541 "T2408152724"
                                                        ...
                                                        if (asEROCode01.includes("NO")) {
                                                            let condition = item => item.EROCode01 === "";
                                                        } else {
                                                            let condition = item => (item.Amount === 0 || item.Amount < anLimitAmt || item.EROCode01 === "" || item.ERODesc01 === "" || item.ERODesc02 === "");
                                                        }
                                                                ...
                                                                if (atestCehcka === 1) { DevExpress.ui.dialog.alert(aArrays.aIncomeAlert[0], aArrays.aIncomeAlert[1]); }
                                                                    ...
                                                                    result.done(function (dresult) {
                                                                        if (dresult) {
                                                                            ...
                                                                            let aObjKeyData = { REFNO: aFREF, Confirmed: aTrueORFalseB, ERStatus: aERStatus };
                                                    ...
                                                    columns: [
                                                            ...
                                                            buttons: [
                                                                {
                                                                    ...
                                                                    onClick: function (e) {
                                                                        ...
                                                                        let aLocalTitle = "";
                                                                        let aSQLCommand = "";
                                                                        let aExitMessage = "All rows of this Reimbursement have deleted !!";
                                                                        let aFrecN = e.row.data.ID;
                                                                        if (aFrecN === 1) {
                                                            ...
                                                            buttons: [
                                                                ...
                                                                },
                                                                {
                                                                    ...
                                                                    onClick: async function (e) {
                                                                        let aUriV = `${aaPFDMI}/temp/uploads/${e.row.data.REFNO}.pdf`
                                                                        console.log(aUriV)
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            setCellValue: function (newData, value, currentRowData) {
                                                                ...
                                                                let giftItem = aObjects.aaLimitedAmt.find(item => item.code === value);
                                                                let giftAmount = giftItem ? giftItem.lmtamt : null;
