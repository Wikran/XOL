...
var aqrFull = "ExpGroupCode LIKE '%" + "300" + "%'" //"PayToCode = '" + asStaffID + "'" // scopes based permission (View Only Login Name)  ExpensesCode LIKE aaOnInitAccCode
...
var jqxhr = $.post(afsettings, function (e) { })
    .done(function (e) {
        ...
        $(() => {
                        ...
                        buttons: [
                            {
                                ...
                                //visible: true,
                                visible: function (e) {
                                    return (e.row.data.ID === 1) //return !e.row.isEditing; && e.row.data.HODApproved === false && e.row.data.Note === "BF"
                                },
                                onClick: function (e) {

                                    var aEmpIDxx = $.trim(e.row.data.PayToCode)
                                    //console.log(aEmpIDxx);
                                    //let aqr2Sx = "EmpID LIKE '%" + $.trim(aaEmpIDx) + "%'"
                                    //let aFieldNx = "EmpName,RefNo01,RefNo02,MonthlyLimited,LimitedPerTime,TotalLimited,AllowFamily,AllowSSO,FleetLimit,MedicalLimit,MaternityLimit,LimitPerCase"
                                    //let aqr2Sx = "Where EmpID LIKE '%" + $.trim(aEmpIDxx) + "%'"   
            ...
            */
            // benefit popup (x)
            function xaPopUpBenefits(iData, aaEmpIDx) { //aaMedical,aaFamily,aaSSO,aaMaternity,aaFleet
                    ...
                    $('#aAgentPivot').dxPivotGrid({
                            ...
                            fields: [
                                ...
                                },
                                {
                                    ...
                                    calculateDisplayValue: function (data) {
                                        const department = aaDeptList.find(dept => dept.DeptCode === data.Department);
                                        return department ? department.ENGNAME : "";
                                    }
                                },
                        ...
                        onExporting(e) {
                            ...
                            DevExpress.excelExporter.exportPivotGrid({
                                ...
                                headerCell.value = 'Expenses Reimbursement [HR]';
                                ...
                                footerCell.value = 'https://cbsdev2.locktonwattana.com/XOL/index.html';
