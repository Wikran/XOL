...
window.addEventListener('load', function (e) {
    ...
    aDXTheme = localStorage["aaDXtm"]; //'generic.light'; //aaDXtm
    localStorage["aDXTheme"] = aDXTheme;
});

$(document).ready(function () {
    var aDXTheme = localStorage["aDXTheme"] // Parameters
    var aUXTheme = localStorage["aaDXtm"]; // User Theme
...
var aaXrgX = localStorage["aaXrXg"]; // getCookie("aaCrCg") //
...
//$(function () { TOP PRG
$(() => {
    var aPwdNoChange = localStorage["asAct"]
    ...
    var aUserNamex = localStorage["aaXXuX"];
